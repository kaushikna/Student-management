...
@Component({
  selector: 'app-tutor-troubles',
  templateUrl: './tutor-troubles.component.html',
  styleUrls: ['./tutor-troubles.component.css']
})
export class TutorTroublesComponent implements OnInit {
